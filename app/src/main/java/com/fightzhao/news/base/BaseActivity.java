...
import com.fightzhao.news.module.news.view.activity.NewsActivity;
import com.fightzhao.news.R;
import com.fightzhao.news.app.ActivityFragmentInject;
import com.fightzhao.news.callback.DrawerListenerAdapter;
import com.fightzhao.news.module.news.view.activity.SettingActivity;
import com.fightzhao.news.utils.GlideCircleTransform;
import com.fightzhao.news.utils.MeasureUtil;
import com.fightzhao.news.utils.RxBus;
import com.fightzhao.news.utils.SlidrUtil;
import com.fightzhao.news.utils.SpUtil;
import com.fightzhao.news.utils.ThemeUtil;
...
public abstract class BaseActivity<T extends BasePresenter> extends AppCompatActivity implements BaseView, View.OnClickListener {
    ...
    private void initNavigationView() {
        ...
        mNavigationView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (imageView != null) {
                    Glide.with(mNavigationView.getContext()).load(R.mipmap.ic_app).crossFade()
        ...
        if (appBarLayout != null && toolbar != null) {
            ...
            appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
                ...
                public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                    if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT || BaseActivity.this instanceof SettingActivity) {
    ...
    private void handleStatusView() {
        ...
        if (Build.VERSION.SDK_INT == Build.VERSION_CODES.KITKAT || this instanceof SettingActivity) {
    ...
    protected void showSnackbar(String msg) {
        ...
        ve.setBackgroundColor(0xff6f00);
        sBar.show();
    }
